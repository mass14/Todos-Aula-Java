...
public class DropShadowBuilder<B extends javafx.scene.effect.DropShadowBuilder<B>> implements javafx.util.Builder<javafx.scene.effect.DropShadow> {
    ...
    public void applyTo(javafx.scene.effect.DropShadow x) {
        int set = __set;
        while (set != 0) {
            ...
            switch (i) {
                ...
                case 1: x.setColor(this.color); break;
                case 2: x.setHeight(this.height); break;
                case 3: x.setInput(this.input); break;
                case 4: x.setOffsetX(this.offsetX); break;
                case 5: x.setOffsetY(this.offsetY); break;
                case 6: x.setRadius(this.radius); break;
                case 7: x.setSpread(this.spread); break;
    ...
    */
    public javafx.scene.effect.DropShadow build() {
        javafx.scene.effect.DropShadow x = new javafx.scene.effect.DropShadow();
        applyTo(x);
        return x;
    }
}
